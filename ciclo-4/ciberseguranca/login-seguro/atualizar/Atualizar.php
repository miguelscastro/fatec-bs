...
<body>
    ...
    <div class="container">
        ...
        <form action="AtualizarUsuario.php" method="post">
            ...
            <input type="text" id="nome" name="nome" required autocomplete="name" value="<?php echo htmlspecialchars($usuario['nome']); ?>">
            <label for="email">Email:</label>
            <input type="email" id="email" name="email" required autocomplete="email" value="<?php echo htmlspecialchars($usuario['email']); ?>">
